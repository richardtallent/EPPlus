...
namespace OfficeOpenXml.ConditionalFormatting {
	...
	public class ExcelConditionalFormattingCollection
	  ...
	  IEnumerable<IExcelConditionalFormattingRule> {
		...
		/// </summary>
		/// <returns></returns>
		IEnumerator<IExcelConditionalFormattingRule> IEnumerable<IExcelConditionalFormattingRule>.GetEnumerator() => _rules.GetEnumerator();

		/// <summary>
		/// Get the 'cfRule' enumerator
		/// </summary>
		/// <returns></returns>
		IEnumerator System.Collections.IEnumerable.GetEnumerator() => _rules.GetEnumerator();
		...
		public IExcelConditionalFormattingRule RulesByPriority(
		  int priority) => _rules.Find(x => x.Priority == priority);
		...
		public IExcelConditionalFormattingAverageGroup AddAboveAverage(
		  ExcelAddress address) => (IExcelConditionalFormattingAverageGroup)AddRule(
		...
		public IExcelConditionalFormattingStdDevGroup AddAboveStdDev(
		  ExcelAddress address) => (IExcelConditionalFormattingStdDevGroup)AddRule(
		...
		public IExcelConditionalFormattingTopBottomGroup AddBottom(
		  ExcelAddress address) => (IExcelConditionalFormattingTopBottomGroup)AddRule(
		...
		public IExcelConditionalFormattingTimePeriodGroup AddLast7Days(
		  ExcelAddress address) => (IExcelConditionalFormattingTimePeriodGroup)AddRule(
		...
		public IExcelConditionalFormattingBeginsWith AddBeginsWith(
		  ExcelAddress address) => (IExcelConditionalFormattingBeginsWith)AddRule(
		...
		public IExcelConditionalFormattingBetween AddBetween(
		  ExcelAddress address) => (IExcelConditionalFormattingBetween)AddRule(
		...
		public IExcelConditionalFormattingContainsBlanks AddContainsBlanks(
		  ExcelAddress address) => (IExcelConditionalFormattingContainsBlanks)AddRule(
		...
		public IExcelConditionalFormattingContainsErrors AddContainsErrors(
		  ExcelAddress address) => (IExcelConditionalFormattingContainsErrors)AddRule(
		...
		public IExcelConditionalFormattingContainsText AddContainsText(
		  ExcelAddress address) => (IExcelConditionalFormattingContainsText)AddRule(
		...
		public IExcelConditionalFormattingDuplicateValues AddDuplicateValues(
		  ExcelAddress address) => (IExcelConditionalFormattingDuplicateValues)AddRule(
		...
		public IExcelConditionalFormattingEndsWith AddEndsWith(
		  ExcelAddress address) => (IExcelConditionalFormattingEndsWith)AddRule(
		...
		public IExcelConditionalFormattingEqual AddEqual(
		  ExcelAddress address) => (IExcelConditionalFormattingEqual)AddRule(
		...
		public IExcelConditionalFormattingExpression AddExpression(
		  ExcelAddress address) => (IExcelConditionalFormattingExpression)AddRule(
		...
		public IExcelConditionalFormattingGreaterThan AddGreaterThan(
		  ExcelAddress address) => (IExcelConditionalFormattingGreaterThan)AddRule(
		...
		public IExcelConditionalFormattingGreaterThanOrEqual AddGreaterThanOrEqual(
		  ExcelAddress address) => (IExcelConditionalFormattingGreaterThanOrEqual)AddRule(
		...
		public IExcelConditionalFormattingLessThan AddLessThan(
		  ExcelAddress address) => (IExcelConditionalFormattingLessThan)AddRule(
		...
		public IExcelConditionalFormattingLessThanOrEqual AddLessThanOrEqual(
		  ExcelAddress address) => (IExcelConditionalFormattingLessThanOrEqual)AddRule(
		...
		public IExcelConditionalFormattingNotBetween AddNotBetween(
		  ExcelAddress address) => (IExcelConditionalFormattingNotBetween)AddRule(
		...
		public IExcelConditionalFormattingNotContainsBlanks AddNotContainsBlanks(
		  ExcelAddress address) => (IExcelConditionalFormattingNotContainsBlanks)AddRule(
		...
		public IExcelConditionalFormattingNotContainsErrors AddNotContainsErrors(
		  ExcelAddress address) => (IExcelConditionalFormattingNotContainsErrors)AddRule(
		...
		public IExcelConditionalFormattingNotContainsText AddNotContainsText(
		  ExcelAddress address) => (IExcelConditionalFormattingNotContainsText)AddRule(
		...
		public IExcelConditionalFormattingNotEqual AddNotEqual(
		  ExcelAddress address) => (IExcelConditionalFormattingNotEqual)AddRule(
		...
		public IExcelConditionalFormattingUniqueValues AddUniqueValues(
		  ExcelAddress address) => (IExcelConditionalFormattingUniqueValues)AddRule(
		...
		public IExcelConditionalFormattingThreeColorScale AddThreeColorScale(
		  ExcelAddress address) => (IExcelConditionalFormattingThreeColorScale)AddRule(
		...
		public IExcelConditionalFormattingTwoColorScale AddTwoColorScale(
		  ExcelAddress address) => (IExcelConditionalFormattingTwoColorScale)AddRule(
