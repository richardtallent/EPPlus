...
namespace OfficeOpenXml.DataValidation {
	...
	public class ExcelDataValidationCollection : XmlHelper, IEnumerable<IExcelDataValidation> {
		...
		private void ValidateAddress(string address) => ValidateAddress(address, null);
		...
		/// <returns></returns>
		public IEnumerable<IExcelDataValidation> FindAll(Predicate<IExcelDataValidation> match) => _validations.FindAll(match);
		...
		IEnumerator<IExcelDataValidation> IEnumerable<IExcelDataValidation>.GetEnumerator() => _validations.GetEnumerator();

		IEnumerator System.Collections.IEnumerable.GetEnumerator() => _validations.GetEnumerator();
	}
}
