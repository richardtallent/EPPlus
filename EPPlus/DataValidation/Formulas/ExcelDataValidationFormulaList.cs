...
namespace OfficeOpenXml.DataValidation.Formulas {
	internal class ExcelDataValidationFormulaList : ExcelDataValidationFormula, IExcelDataValidationFormulaList {
		...
		private class DataValidationList : IList<string>, ICollection {
			...
			int IList<string>.IndexOf(string item) => _items.IndexOf(item);
			...
			public void CopyTo(Array array, int index) => _items.CopyTo((string[])array, index);
		...
		internal override void ResetValue() => Values.Clear();
	}
}
