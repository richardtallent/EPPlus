...
namespace OfficeOpenXml.Drawing.Chart {
	...
	public class ExcelChartTrendlineCollection : IEnumerable<ExcelChartTrendline> {
		...
		IEnumerator<ExcelChartTrendline> IEnumerable<ExcelChartTrendline>.GetEnumerator() => _list.GetEnumerator();
	...
	public class ExcelChartTrendline : XmlHelper {
		internal ExcelChartTrendline(XmlNamespaceManager namespaceManager, XmlNode topNode) :
			base(namespaceManager, topNode) => SchemaNodeOrder = new string[] { "name", "trendlineType", "order", "period", "forward", "backward", "intercept", "dispRSqr", "dispEq", "trendlineLbl" };
