...
namespace OfficeOpenXml.Drawing.Chart {
	...
	public class ExcelOfPieChart : ExcelPieChart {
		...
		internal ExcelOfPieChart(ExcelDrawings drawings, XmlNode node, eChartType type, bool isPivot) :
			base(drawings, node, type, isPivot) => SetTypeProperties();
		...
		private void SetTypeProperties() => OfPieType = ChartType == eChartType.BarOfPie ? ePieType.Bar : ePieType.Pie;
		...
		public ePieType OfPieType {
			get {
				return _chartXmlHelper.GetXmlNodeString(pieTypePath) == "bar" ? ePieType.Bar : ePieType.Pie;
			}
			internal set {
