...
namespace OfficeOpenXml.Drawing {
	...
	public class ExcelDrawings : IEnumerable<ExcelDrawing>, IDisposable {
		...
		public IEnumerator GetEnumerator() => (_drawings.GetEnumerator());
		#region IEnumerable<ExcelDrawing> Members

		IEnumerator<ExcelDrawing> IEnumerable<ExcelDrawing>.GetEnumerator() => (_drawings.GetEnumerator());
		...
		/// <param name="ChartType">Type of chart</param>
		/// <returns>The chart</returns>
		public ExcelChart AddChart(string Name, eChartType ChartType) => AddChart(Name, ChartType, null);
		...
		public void Remove(ExcelDrawing Drawing) => Remove(_drawingNames[Drawing.Name]);

		/// <summary>
		/// Removes a drawing.
		/// </summary>
		/// <param name="Name">The name of the drawing</param>
		public void Remove(string Name) => Remove(_drawingNames[Name]);
