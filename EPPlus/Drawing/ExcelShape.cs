...
namespace OfficeOpenXml.Drawing {
	...
	public sealed class ExcelShape : ExcelDrawing {
		internal ExcelShape(ExcelDrawings drawings, XmlNode node) :
			base(drawings, node, "xdr:sp/xdr:nvSpPr/xdr:cNvPr/@name") => init();
		...
		private void init() => SchemaNodeOrder = new string[] { "prstGeom", "ln", "pPr", "defRPr", "solidFill", "uFill", "latin", "cs", "r", "rPr", "t" };
