...
namespace OfficeOpenXml.Drawing.Vml {
	internal class ExcelVmlDrawingCommentCollection : ExcelVmlDrawingBaseCollection, IEnumerable {
		...
		internal bool ContainsKey(ulong rangeID) => _drawings.ContainsKey(rangeID);
		internal int Count => _drawings.Count;
		#region IEnumerable Members

		#endregion

		public IEnumerator GetEnumerator() => _drawings;

		IEnumerator IEnumerable.GetEnumerator() => _drawings;
	}
}
