...
namespace OfficeOpenXml {
	...
	public class ExcelColumn : IRangeID {
		...
		public override string ToString() => string.Format("Column Range: {0} to {1}", _colElement.GetAttribute("min"), _colElement.GetAttribute("min"));
		...
		internal ExcelColumn Clone(ExcelWorksheet added) => Clone(added, ColumnMin);
