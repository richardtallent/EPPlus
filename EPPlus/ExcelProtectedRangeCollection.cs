...
namespace OfficeOpenXml {
	public class ExcelProtectedRangeCollection : XmlHelper, IEnumerable<ExcelProtectedRange> {
		...
		public bool Contains(ExcelProtectedRange item) => _baseList.Contains(item);

		public void CopyTo(ExcelProtectedRange[] array, int arrayIndex) => _baseList.CopyTo(array, arrayIndex);
		...
		public int IndexOf(ExcelProtectedRange item) => _baseList.IndexOf(item);

		public void RemoveAt(int index) => _baseList.RemoveAt(index);
		...
		IEnumerator<ExcelProtectedRange> IEnumerable<ExcelProtectedRange>.GetEnumerator() => _baseList.GetEnumerator();

		System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator() => _baseList.GetEnumerator();
	}
}
