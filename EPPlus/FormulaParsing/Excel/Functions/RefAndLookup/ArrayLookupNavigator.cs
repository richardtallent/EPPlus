...
namespace OfficeOpenXml.FormulaParsing.Excel.Functions.RefAndLookup {
	public class ArrayLookupNavigator : LookupNavigator {
		...
		private void SetCurrentValue() => _currentValue = _arrayData[_index];

		private bool HasNext() => Direction == LookupDirection.Vertical ? _index < (_arrayData.Length - 1) : false;
		...
		public override object GetLookupValue() => _arrayData[_index].Value;
	}
}
