...
namespace OfficeOpenXml {
	...
	public class ExcelErrorValue {
		...
		private ExcelErrorValue(eErrorType type) => Type = type;
		...
		public override bool Equals(object obj) => !(obj is ExcelErrorValue) ? false : ((ExcelErrorValue)obj).ToString() == this.ToString();
	}
}
