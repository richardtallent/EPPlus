...
namespace OfficeOpenXml.FormulaParsing {
	...
	public class ParsingScopes {
		...
		public ParsingScopes(IParsingLifetimeEventHandler lifetimeEventHandler) => _lifetimeEventHandler = lifetimeEventHandler;
		...
		public virtual ParsingScope NewScope(RangeAddress address) {
			ParsingScope scope = _scopes.Count() > 0 ? new ParsingScope(this, _scopes.Peek(), address) : new ParsingScope(this, address);
			_scopes.Push(scope);
			return scope;
		}
