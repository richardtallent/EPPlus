...
namespace OfficeOpenXml.Packaging.Ionic.Zip {
	...
	internal partial class ZipEntry {
		...
		///
		/// </remarks>
		internal void Extract() => InternalExtract(".", null, null);
		...
		/// </param>
		///
		public void Extract(Stream stream) => InternalExtract(null, stream, null);
		...
		/// </para>
		/// </remarks>
		public void Extract(string baseDirectory) => InternalExtract(baseDirectory, null, null);
		...
		public void ExtractWithPassword(string password) => InternalExtract(".", null, password);
		...
		/// <param name="baseDirectory">The pathname of the base directory.</param>
		/// <param name="password">The Password to use for decrypting the entry.</param>
		public void ExtractWithPassword(string baseDirectory, string password) => InternalExtract(baseDirectory, null, password);
		...
		/// </param>
		public void ExtractWithPassword(Stream stream, string password) => InternalExtract(null, stream, password);
		...
		private void InternalExtract(string baseDir, Stream outstream, string password) {
			...
			try {
				...
				var p = password ?? this._Password ?? this._container.Password;
