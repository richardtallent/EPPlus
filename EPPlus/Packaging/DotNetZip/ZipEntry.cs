...
namespace OfficeOpenXml.Packaging.Ionic.Zip {
	...
	internal partial class ZipEntry {
		...
		public System.IO.FileAttributes Attributes {
			// workitem 7071
			get => (System.IO.FileAttributes)_ExternalFileAttrs;
			set {
		...
		public Nullable<bool> RequiresZip64 => _entryRequiresZip64;
		...
		public OfficeOpenXml.Packaging.Ionic.Zlib.CompressionLevel CompressionLevel {
			...
			set {
				...
				_CompressionMethod = _CompressionLevel == OfficeOpenXml.Packaging.Ionic.Zlib.CompressionLevel.None
					? (short)OfficeOpenXml.Packaging.Ionic.Zip.CompressionMethod.None
					: (short)OfficeOpenXml.Packaging.Ionic.Zip.CompressionMethod.Deflate;
		...
		public Int64 CompressedSize => _CompressedSize;
		...
		public Int64 UncompressedSize => _UncompressedSize;
		...
		public bool UseUnicodeAsNecessary {
			get => (AlternateEncoding == System.Text.Encoding.GetEncoding("UTF-8")) &&
		...
		private void SetFdpLoh() {
			...
			var origPosition = this.ArchiveStream.Position;
			try {
