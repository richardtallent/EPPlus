...
namespace OfficeOpenXml.Packaging.Ionic.Zip {
	...
	IDisposable {
		...
		public bool ContainsEntry(string name) =>
			// workitem 12534
			_entries.ContainsKey(SharedUtilities.NormalizePathForUseInZipFile(name));
		...
		public bool UseUnicodeAsNecessary {
			get => (_alternateEncoding == System.Text.Encoding.GetEncoding("UTF-8")) &&
		...
		///   </para>
		/// </remarks>
		public static System.Version LibraryVersion => System.Reflection.Assembly.GetExecutingAssembly().GetName().Version;
		...
		/// </code>
		/// </example>
		public ZipFile() => _InitInstance(null, null);
		...
		/// </returns>
		///
		public System.Collections.Generic.ICollection<String> EntryFileNames => _entries.Keys;
		...
		public System.Collections.Generic.ICollection<ZipEntry> Entries => _entries.Values;
