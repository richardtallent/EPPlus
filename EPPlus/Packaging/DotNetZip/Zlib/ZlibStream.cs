...
namespace OfficeOpenXml.Packaging.Ionic.Zlib {
	...
	public class ZlibStream : System.IO.Stream {
		...
		/// </param>
		public ZlibStream(System.IO.Stream stream, CompressionMode mode, CompressionLevel level, bool leaveOpen) => _baseStream = new ZlibBaseStream(stream, mode, level, ZlibStreamFlavor.ZLIB, leaveOpen);
		...
		public override long Position {
			get {
				...
				return this._baseStream._streamMode == Ionic.Zlib.ZlibBaseStream.StreamMode.Reader ? this._baseStream._z.TotalBytesIn : 0;
			}
