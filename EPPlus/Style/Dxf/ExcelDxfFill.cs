namespace OfficeOpenXml.Style.Dxf {
	public class ExcelDxfFill : DxfStyleBase<ExcelDxfFill> {
		...
		protected internal override bool HasValue => PatternType != null ||
					PatternColor.HasValue ||
					BackgroundColor.HasValue;
		protected internal override ExcelDxfFill Clone() => new ExcelDxfFill(_styles) { PatternType = PatternType, PatternColor = PatternColor.Clone(), BackgroundColor = BackgroundColor.Clone() };
	}
}
