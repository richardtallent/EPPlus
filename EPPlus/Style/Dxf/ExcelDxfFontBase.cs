namespace OfficeOpenXml.Style.Dxf {
	public class ExcelDxfFontBase : DxfStyleBase<ExcelDxfFontBase> {
		public ExcelDxfFontBase(ExcelStyles styles)
			: base(styles) => Color = new ExcelDxfColor(styles);
		...
		protected internal override bool HasValue => Bold != null ||
					   Italic != null ||
					   Strike != null ||
					   Underline != null ||
					   Color.HasValue;
		protected internal override ExcelDxfFontBase Clone() => new ExcelDxfFontBase(_styles) { Bold = Bold, Color = Color.Clone(), Italic = Italic, Strike = Strike, Underline = Underline };
	}
}
