...
namespace OfficeOpenXml.Style {
	...
	public sealed class Border : StyleBase {
		internal Border(ExcelStyles styles, OfficeOpenXml.XmlHelper.ChangedEventHandler ChangedEvent, int PositionID, string address, int index) :
			base(styles, ChangedEvent, PositionID, address) => Index = index;
		...
		public bool DiagonalUp {
			get {
				return Index >= 0 ? _styles.Borders[Index].DiagonalUp : false;
			}
		...
		public bool DiagonalDown {
			get {
				return Index >= 0 ? _styles.Borders[Index].DiagonalDown : false;
			}
