...
namespace OfficeOpenXml.Style {
	...
	public class ExcelRichText : XmlHelper {
		...
		internal void SetCallback(CallbackDelegate callback) => _callback = callback;
		...
		public bool PreserveSpace {
			get {
				return TopNode.SelectSingleNode(TEXT_PATH, NameSpaceManager) is XmlElement elem ? elem.GetAttribute("xml:space") == "preserve" : false;
			}
			set {
				_collection.ConvertRichtext();
