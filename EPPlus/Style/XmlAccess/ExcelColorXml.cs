...
namespace OfficeOpenXml.Style.XmlAccess {
	...
	public sealed class ExcelColorXml : StyleXmlHelper {
		...
		public decimal Tint {
			get {
				return _tint == decimal.MinValue ? 0 : _tint;
			}
			set {
				_tint = value;
				_exists = true;
		...
		internal ExcelColorXml Copy() => new ExcelColorXml(NameSpaceManager) { _indexed = _indexed, _tint = _tint, _rgb = _rgb, _theme = _theme, _auto = _auto, _exists = _exists };
