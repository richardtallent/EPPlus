...
namespace OfficeOpenXml.Table.PivotTable {
	...
	public class ExcelPivotTable : XmlHelper {
		...
		private void init() => SchemaNodeOrder = new string[] { "location", "pivotFields", "rowFields", "rowItems", "colFields", "colItems", "pageFields", "pageItems", "dataFields", "dataItems", "formats", "pivotTableStyleInfo" };
