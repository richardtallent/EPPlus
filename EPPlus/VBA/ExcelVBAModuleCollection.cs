...
namespace OfficeOpenXml.VBA {
	...
	public class ExcelVBACollectionBase<T> : IEnumerable<T> {
		...
		public bool Exists(string Name) => _list.Exists((f) => TypeCompat.GetPropertyValue(f, "Name").ToString().Equals(Name, StringComparison.OrdinalIgnoreCase));
	...
	public class ExcelVbaModuleCollection : ExcelVBACollectionBase<ExcelVBAModule> {
		...
		internal void Add(ExcelVBAModule Item) => _list.Add(Item);
	...
	public class ExcelVbaReferenceCollection : ExcelVBACollectionBase<ExcelVbaReference> {
		...
		public void Add(ExcelVbaReference Item) => _list.Add(Item);
	}
