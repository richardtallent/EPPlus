...
namespace EPPlusTest.DataValidation {
	...
	public class DecimaDataValidationTests : ValidationTestBase {
		...
		[TestMethod]
		public void DecimalDataValidation_Formula1IsSet() => Assert.IsNotNull(_validation.Formula);

		[TestMethod]
		public void DecimalDataValidation_Formula2IsSet() => Assert.IsNotNull(_validation.Formula2);
	}
}
