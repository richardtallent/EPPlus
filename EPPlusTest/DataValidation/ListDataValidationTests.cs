...
namespace EPPlusTest.DataValidation {
	...
	public class ListDataValidationTests : ValidationTestBase {
		...
		[TestCleanup]
		public void Cleanup() => CleanupTestData();

		[TestMethod]
		public void ListDataValidation_FormulaIsSet() => Assert.IsNotNull(_validation.Formula);
		...
		public void ListDataValidation_ShouldThrowWhenNoFormulaOrValueIsSet() => _validation.Validate();
	}
}
