...
namespace EPPlusTest.Excel {
	...
	public class OperatorsTests {
		...
		[TestMethod]
		public void OperatorMultiplyShouldThrowExceptionIfNonNumericOperand() => Operator.Multiply.Apply(new CompileResult(1, DataType.Integer), new CompileResult("a", DataType.String));
		...
		public void OperatorsActingOnNumericStrings() {
			var number1 = 42.0;
			var number2 = -143.75;
			var result1 = new CompileResult(number1.ToString("n"), DataType.String);
			var result2 = new CompileResult(number2.ToString("n"), DataType.String);
		...
		public void OperatorsActingOnDateStrings() {
			...
			var date1 = new DateTime(2015, 2, 20);
			var date2 = new DateTime(2015, 12, 1);
			var numericDate1 = date1.ToOADate();
			var numericDate2 = date2.ToOADate();
			var result1 = new CompileResult(date1.ToString(dateFormat), DataType.String); // 2/20/2015
			var result2 = new CompileResult(date2.ToString(dateFormat), DataType.String); // 12/1/2015
			var operatorResult = Operator.Concat.Apply(result1, result2);
