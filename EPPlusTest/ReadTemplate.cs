...
namespace EPPlusTest {
	...
	public class ReadTemplate //: TestBase
	{
		...
		public void ReadBug3() {
			var xlsPack = new ExcelPackage(new FileInfo(@"c:\temp\billing_template.xlsx"));
		...
		public void Finnished() => _threadCount--;
		private class ThreadState {
			public ThreadState(cbFinished cb) => _cb = cb;
