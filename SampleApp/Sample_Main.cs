	...
	class Sample_Main {
		static void Main(string[] args) {
			try {
				...
				var connectionStr = "";      //for example "Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=AdventureWorks2016CTP3;Data Source=MySqlServer"
				...
				var sample1Path = Sample1.RunSample1();
